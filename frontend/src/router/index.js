...
const routes = [
  ...
  { path: "/movies/:id", component: MovieDetails, meta: { requiresAuth: true, hideFooter: true, hideNavbar: true } },
  { path: "/my-bookings", component: MyBookings, meta: { requiresAuth: true, hideFooter: true, hideNavbar: true } },
