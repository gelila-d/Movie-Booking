  ...
  <div class="min-h-screen flex items-center justify-center bg-[#050505] p-4 relative select-none overflow-hidden">
    ...
    <div class="relative z-10 bg-transparent border border-white/10 hover:border-[#ef6a26]/40 transition-colors duration-500 p-6 sm:p-7 rounded-3xl w-full max-w-md shadow-none backdrop-blur-none">
      ...
      <div class="flex flex-col items-center mb-5">
        ...
        <h1 class="text-xl font-bold text-white font-orbitron tracking-wide">CREATE AN ACCOUNT</h1>
        <p class="text-xs text-slate-300 mt-0.5">Join Movies today to start booking tickets</p>
      </div>
      ...
      <form @submit.prevent="register" class="space-y-3.5">
        <div>
          <label class="block text-xs font-semibold uppercase tracking-wider text-slate-200 mb-1 font-mono">Full Name</label>
          <input 
            v-model="name" 
            type="text" 
            required
